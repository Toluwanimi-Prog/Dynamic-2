...
library(plotly)
library(dplyr)
mydata <- read_excel("/Users/abigailtako/Documents/Fall 2024/Visualizations/GroupProject1/Table_Project.xlsx", sheet = "Sheet2")
str(mydata)
```

# Highlights the event on 2007-2008 and 2019-2020
